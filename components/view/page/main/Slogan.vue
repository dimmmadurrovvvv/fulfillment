<template>
    <section class="main-page-slogan">
        <div class="main-page-slogan__inner">
            ...
            <div class="main-page-slogan__image">
                <img class="main-page-slogan__image-pic"
                    src="/images/static/slogan-pic.png"
                    alt="Иллюстрация слогана">
            </div>
        </div>
    </section>
</template>
